...
// //  const submit=async()=>{
// //   try{
// //     if(Values.username==="" || Values.password==="" || Values.address===""){
// //       alert("All fields are required");
// //     }
// //     else{
...
// //         </div>
// //         <div className="mt-4">
// //           <button className="w-full bg-blue-500 text-white font-semibold py-2 rounded hover:to-blue-600 transition-all duration-300" 
// //           onClick={submit}
// //           >SignUp</button>
// //         </div>
// //         <p className="flex mt-4 items-center justify-center text-zinc-200 font-semibold">

...
const Sidebar = ({data}) => {
  ...
  return (
    ...
    {role==="user" && ( <div className="w-full flex-col items-center justify-center hidden lg:flex">
        ...
        className="text-zinc-10 font-semibold w-full py-2 mt-4 text-center hover:bg-zinc-900 rounded transition-all duration-300">
        Settings
        </Link>
      </div>
    )}
...
// const Sidebar = ({ data }) => {
//   return (
//     <div className="bg-zinc-800 p-4 rounded flex flex-col items-between items-center justify-between h-[100%]">
//       <div className="flex items-center flex-col justify-center">

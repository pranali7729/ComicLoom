  ...
  return (
    ...
    <nav className="z-50 relative flex bg-zinc-800 text-white px-8 py-4 items-center justify-between">
        <Link to="/" className="flex items-center">
            ...
            alt="logo" 
            />
            <h1 className="text-2xl font-semibold">ComicLoom</h1>
        </Link>
        <div className='nav-links-bookheaven block md:flex items-center gap-4'>
            ...
            {links.map((items,i)=>(
             ...
             {isLoggedIn===false && (
                ...
                <Link 
                  to="/SignUp" 
                  className="px-4 py-1 border bg-blue-500 rounded hover:bg-white hover:text-zinc-800 transition duration-300">
                    SignUp
                    </Link>
                </div>
             )}
    ...
    {links.map((items,i)=>(
                ...
                >
                    ...
                    <Link 
                    to="/SignUp" 
                    className={`${MobileNav} px-8 mb-8 text-3xl font-semibold py-2 border bg-blue-500 rounded text-white hover:bg-white hover:text-zinc-800 transition duration-300`}>
                    SignUp
                    </Link>
                    </>
                    )}
